...
function CredentialsErrorModal({showBadCredantialsErrorModal, setShowBadCredantialsErrorModal}) {
    ...
    return (
        <Modal show={showBadCredantialsErrorModal} onHide={showBadCredantialsErrorModalCloseHandler}>
            ...
            <Modal.Body>
                Некорректные реквизиты доступа к платформе IOT Tuya. Введите корректные данные <a href="/user/profile/">в
                профиле</a> пользователя
            </Modal.Body>
            <Modal.Footer>
                <Button variant="primary" href="/user/profile/"><i className="bi bi-person-fill"></i> Профиль
                    пользователя</Button>
